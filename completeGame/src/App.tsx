...
function App() {
  ...
  return (
    ...
    <div className='flex gap-2 p-4'>
      <Button> Energía {playerInfo.energia}</Button>
      <Button> Conocimiento {playerInfo.conocimiento}</Button>
      <Button> Relaciones Sociales {playerInfo.social}</Button>
      <Button> Dinero {playerInfo.money}</Button>
    </div>
